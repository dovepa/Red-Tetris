...
declare namespace Router {
    ...
    export type IParamMiddleware = (param: string, ctx: RouterContext, next: () => Promise<any>) => any;
...
declare class Router<StateT = any, CustomT = {}> {
     ...
     */
    use(...middleware: Router.IMiddleware<StateT, CustomT>[]): Router<StateT, CustomT>;
    use(
